      ...
      {/* HERO */}
       ...
       <div className='space-y-8'>
        ...
        <h1 className='text-5xl lg:text-7xl font-black leading-tight'>
          <span className='bg-gradient-to-r from-primary via-secondary to-accent bg-clip-text text-transparent'>Code Together,
          </span>
          <br />
            ...
            <div className='grid md:grid-cols-3 gap-8'>
             ...
             <div className='card bg-base-100 shadow-xl'>
              <div className='card-body items-center text-center'>
                ...
                <p className='text-base-content/70'>Crysal clear video and audio for seamless communication during interviews</p>
              </div>
             </div>
             ...
             <div className='card bg-base-100 shadow-xl'>
              <div className='card-body items-center text-center'>
                ...
                <p className='text-base-content/70'>Crysal Collaborate in real-time with syntax highlighting and multiple language support </p>
              </div>
             </div>
