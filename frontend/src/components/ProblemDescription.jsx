...
const ProblemDescription = ({problem,currenProblemId,onProblemChange,allProblems}) => {
  return (
    <div className='h-full overflow-y-auto bg-base-200'>
      ...
      <div className='p-6 bg-base-100 border border-base-300'>
        ...
        <p className='text-base-content/60'>{problem.catagory}</p>
      ...
      <div className='p-6 space-y-6'>
        ...
        <div className='bg-base-100 rounded-xl  shadow-sm p-5 border border-base-300'>
          <h2 className='text-xl font-bold textbase'>Description</h2>
